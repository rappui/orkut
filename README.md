...
```
https://orderkuota-proxy.vercel.app
```

## Tools

Dapatkan Token & QRIS Static dengan mudah: [https://orderkuota-proxy.vercel.app/tools.html](https://orderkuota-proxy.vercel.app/tools.html)
...
Gunakan [halaman Tools](https://orderkuota-proxy.vercel.app/tools.html) atau:

```bash
# Request OTP
curl -X POST https://orderkuota-proxy.vercel.app/api/auth/otp \
  -H "Content-Type: application/json" \
  -d '{"username":"OK123456","password":"yourpassword"}'

# Dapatkan Token dengan OTP
curl -X POST https://orderkuota-proxy.vercel.app/api/auth/token \
  -H "Content-Type: application/json" \
...
```bash
curl -X POST https://orderkuota-proxy.vercel.app/api/qris/image \
  -H "Content-Type: application/json" \
...
1. Gunakan [halaman Tools](https://orderkuota-proxy.vercel.app/tools.html) (direkomendasikan)
